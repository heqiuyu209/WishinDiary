...
<template>
  <div class="app-shell min-h-screen overflow-x-hidden text-slate-800 font-sans selection:bg-rose-200">
...
.app-ambient {
  ...
  background:
    ...
    radial-gradient(circle at 50% 100%, rgb(254 205 211 / 0.28), transparent 34rem),
    #fdfdfe;
